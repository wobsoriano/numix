...
Numix provides you with server side scripts inside your Nuxt pages, which will be transformed to a virtual module and called inside a [Nitro handler](https://nitro.unjs.io/guide/introduction/routing). Loader functions and actions similar to Remix.
